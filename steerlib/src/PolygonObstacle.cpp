...
void PolygonObstacle::draw()
{
    ...
    Util::AxisAlignedBox getBounds2(){
    	Util::Point center  =  Util::Point(0,0,0);
    	float _radius2 = 4.0;
    	Util::AxisAlignedBox bound(center.x-_radius2, center.x+_radius2, 0.0f, 0.0f, center.z-_radius2, center.z+_radius2);
    	return bound;
    }
